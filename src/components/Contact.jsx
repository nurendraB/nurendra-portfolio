      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            Interested in collaborating, discussing cybersecurity,
            bug bounty findings, security assessments, or opportunities?
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <a
                href="mailto:spiderinshell8@duck.com"
            ...
            <div className="mt-10 border-t border-slate-800 pt-6">
              <h4 className="font-semibold mb-4">Security Focus Areas</h4>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <input
                ...
                required
                minLength={2}
                className="w-full p-4 rounded-xl bg-slate-950 border border-slate-800 focus:outline-none focus:border-green-500"
              />
              <input
                type="email"
                name="email"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-green-500 hover:bg-green-600 disabled:opacity-50 transition py-4 rounded-xl font-medium"
              >
                {loading ? "Sending..." : "Send Message"}
              </button>
              {result && (
                <div className="text-center mt-4 text-sm text-gray-200">{result}</div>
              )}
            </form>
          </div>
        </div>
